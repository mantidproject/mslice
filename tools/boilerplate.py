...
This script copies the approach take by matplotlib.pyplot to generate the pyplot api.
...
MISC_METHOD_TEMPLATE = AUTOGEN_MSG + """
@_copy_docstring_and_deprecators(Axes.{called_name})
def {name}{signature}:
    return gca().{called_name}{call}
"""
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        pyplot_path = Path(__file__).parent / "../src/mslice/plotting/pyplot.py"
