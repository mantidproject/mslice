...
from mslice.presenters.interfaces.workspace_manager_presenter import (
    WorkspaceManagerPresenterInterface,
)
...
class MainPresenterTests(unittest.TestCase):
    def setUp(self):
        ...
        self.workspace_presenter = mock.create_autospec(
            WorkspaceManagerPresenterInterface
        )
        self.workspace_presenter.get_selected_workspaces = mock.Mock(
    ...
    def test_subscribe_invalid_listener_fail(self):
        ...
        self.assertRaises(
            TypeError, main_presenter.subscribe_to_workspace_selection_monitor, x()
        )
