...
class PlotFigureTest(unittest.TestCase):
    ...
    def test_save_slice_nexus_sofqe(self):
        ...
        with (
            patch(
                "mslice.plotting.plot_window.plot_figure_manager.get_save_directory"
            ) as get_save_dir,
            patch(
                "mslice.models.workspacemanager.workspace_algorithms.save_nexus"
            ) as save_nexus,
            patch(
    ...
    def test_save_slice_matlab_gdos(self):
        ...
        with (
            ...
            patch(
                "mslice.models.workspacemanager.workspace_algorithms.save_matlab"
            ) as save_matlab,
            patch(
                "mslice.models.workspacemanager.workspace_algorithms.get_workspace_handle"
            ) as get_handle,
