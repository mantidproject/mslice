...
class WorkspaceAlgorithmsTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.indirect_workspace = create_simulation_workspace(
            "Indirect", "OSIRIS_workspace"
        )
        ...
        cls.extended_workspace = AppendSpectra(
            InputWorkspace1="OSIRIS_workspace",
            InputWorkspace2="extra_spectra_ws",
        ...
        cls.pixel_workspace = ConvertToMD(
        ...
        cls.histo_workspace = HistogramWorkspace(
            create_md_histo_workspace(2, "histo_workspace"), "histo_workspace"
        )
    ...
    def test_process_limits_will_raise_a_runtime_error_for_a_workspace_where_not_every_histogram_has_a_detector(
        self,
    ):
        with self.assertRaises(RuntimeError):
            process_limits(self.extended_workspace)

    def test_process_limits_events_will_raise_an_attribute_error_for_pixel_workspace(
        self,
    ):
    ...
    def test_remove_workspace_from_ads(self):
        test_workspace2 = CloneWorkspace(
            OutputWorkspace="test_workspace2", InputWorkspace=self.test_workspace
        )
