...
class NumpyHelperTest(unittest.TestCase):
    ...
    def test_is_real_number_returns_false_when_provided_a_string_that_cannot_be_converted_to_float(
        self,
    ):
    ...
    def test_is_real_number_returns_true_for_a_valid_real_number_in_scientific_notation(
        self,
    ):
