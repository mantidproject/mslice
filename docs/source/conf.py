...
from src.mslice import version_info
...
#
# The short X version.
version = '.'.join(map(str, version_info[:1]))
# The full X.Y version.
release = '.'.join(map(str, version_info[:2]))
...
latex_documents = [
  (master_doc, 'MSlice.tex', u'MSlice Documentation',
   u'Mantid Project', 'manual'),
]
...
man_pages = [
    (master_doc, 'mslice', u'MSlice Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'MSlice', u'MSlice Documentation',
   author, 'MSlice', 'One line description of project.',
   'Miscellaneous'),
]
