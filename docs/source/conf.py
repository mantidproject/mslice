...
latex_documents = [
    (master_doc, "MSlice.tex", "MSlice Documentation", "Mantid Project", "manual"),
]
...
man_pages = [(master_doc, "mslice", "MSlice Documentation", [author], 1)]
