...
With ``conda install -c mantid mslice`` you can install the released conda package, with ``conda install -c mantid/label/nightly mslice``
the latest nightly conda package.
