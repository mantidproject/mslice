...
class SliceFunctionsTest(unittest.TestCase):
    ...
    def test_slice(self, alg_mock):
        ...
        plot, boundaries = compute_slice('test_ws', self.q_axis, self.e_axis, False)
    ...
    def test_compute_chi(self):
        chi = compute_chi(self.sim_scattering_data, 10, self.e_axis, True)
        chi_rotated = compute_chi(self.scattering_rotated, 10, self.e_axis, False)
    ...
    def test_compute_d2sigma(self, ws_handle_mock):
        ...
        d2sigma = compute_d2sigma(self.sim_scattering_data, None, self.e_axis, True)
        d2sigma_rotated = compute_d2sigma(self.scattering_rotated, None, self.e_axis, False)
    ...
    def test_compute_symmetrised(self):
        symmetrised = compute_symmetrised(self.sim_scattering_data, 10, self.e_axis, True)
        symmetrised_rotated = compute_symmetrised(self.scattering_rotated, 10, self.e_axis, False)
    ...
    def test_compute_gdos(self):
        gdos = compute_gdos(self.sim_scattering_data, 10, self.q_axis, self.e_axis, True)
        gdos_rotated = compute_gdos(self.scattering_rotated, 10, self.q_axis, self.e_axis, False)
