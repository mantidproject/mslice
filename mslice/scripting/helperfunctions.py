...
MPL_COLORS_IMPORT = ["import matplotlib.colors as colors"]
...
def header(plot_handler):
    ...
    if isinstance(plot_handler, SlicePlot) and plot_handler.colorbar_log is False:
        "\n".join(MPL_COLORS_IMPORT)
    if isinstance(plot_handler, CutPlot) and (plot_handler.x_log is False or plot_handler.y_log is False):
        statements.append("\n".join(NUMPY_IMPORT))
